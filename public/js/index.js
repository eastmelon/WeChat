...
HiChat.prototype = {
    init: function() {//此方法初始化程序
        ...
        this.socket.on('showMes', function(user,msg,color) {
    ...
    _initialEmoji: function() {
        ...
        for (var i = 40; i > 0; i--) {
            ...
            emojiItem.src = '/public/content/emoji/' + i + '.gif';
            emojiItem.title = i;
    ...
    _showEmoji: function(msg) {
        ...
        while (match = reg.exec(msg)) {
            ...
            if (emojiIndex > totalEmojiNum) {
                ...
                result = result.replace(match[0], '<img class="emoji" src="/public/content/emoji/' + emojiIndex + '.gif" />');
            };
        };
        return result;
    }
